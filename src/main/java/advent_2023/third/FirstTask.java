        ...
        for (int i = 0; i < rows; i++) {
            for (int j = 0; j < columns; j++) {
                ...
                if (Character.isDigit(current)) {
                    ...
                    if(!hasAdjacent) {
                        System.out.println("Skip because adjacents are");

                        if(j + 1 < columns) {
                            System.out.println(lines[i].charAt(j + 1));
                        } else {
                            System.out.println(".");
                        }
                        ...
                        if(i + 1 < rows) {
                            System.out.println(lines[i + 1].charAt(j));
                        } else {
                            System.out.println(".");
                        }
                        ...
                        if(i + 1 < rows && j + 1 < columns) {
                            System.out.println(lines[i + 1].charAt(j + 1));
                        } else {
                            System.out.println(".");
                        }
