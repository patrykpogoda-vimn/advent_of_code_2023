...
public class SecondTask {
        ...
        private static Integer assessCardTypeStrength(String card) {
                ...
                //Five of a kind JJJJJ or JJJAA OR JJAAA OR AAAAA
                if(jokers == 5) return 7;
                if (letters.size() == 1) return 7;

                var maxValue = letters.values().stream().max(Integer::compareTo).get();

                //Four of a kind AAAAB JAAAB JJAAB
                if(letters.size() == 2 && letters.containsValue(4)) return 6;
                if(letters.size() == 2 && maxValue + jokers == 4) return 6;

                //Full house AAABB JAABB
                if(letters.size() == 2 && letters.containsValue(3) && letters.containsValue(2)) return 5;
                if(letters.size() == 2 && jokers == 1 && letters.containsValue(2)) return 5;

                //Three of a kind AAABC AJABC
                if(letters.size() == 3 && letters.containsValue(3) && letters.containsValue(1)) return 3;
                if(letters.size() == 3 && jokers == 2) return 3;
                if(letters.size() == 3 && letters.containsValue(2) && letters.containsValue(1) && jokers == 1) return 3;

                //Two pair AABBC
                if(letters.size() == 3 && letters.containsValue(2) && letters.containsValue(1)) return 2;

                //ONE Pair AABCD AJBCD
